...
def main():
    ...
    PRODUTOS_POOL = [
        ...
        {"ranking": 6, "nome": "Liv Pure", "status": "🔥 ALTA", "plataforma": "ClickBank", "base_mes": 65000, "base_hoje": 1420, "melhor_pais": "Estados Unidos (USA)", "semente": 64,
         ...
         "porque": "Excelente cenario de Upsell do produtor gringo. O veredicto indica que rodar tráfego direto para termos institucionais exatos entrega alto retorno liquido em dolares."},
