...
def main():
    ...
    estilo_luxo += "[data-testid='stAppViewContainer'] div.stAlert {background-color: #0f172a !important; border: 1px solid #1e293b !important;}"
    estilo_luxo += "</style>"
    ...
    # Injeção promocional do link de indicação exato solicitado
    url_afiliado = "https://www.hostinger.com/br?REFERRALCODE=VBMCONTAT7WC"
    ...
    if produto_nome:
        ...
        # Definição conceitual de cada bloco da página ponte
        ...
        # Exibição organizada dos passos em colunas SaaS
        c_passo1, c_passo2 = st.columns(2)
        with c_passo1:
        ...
        # Textos oficiais formatados lineares livres de erros do compilador
